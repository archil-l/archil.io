...
const Work = ({ $sectionid, $role, size }: SectionProps) => {
  ...
  return (
    <SectionWrapper $sectionid={$sectionid} $role={$role} size={size}>
      ...
      <WrappedImg src="https://helpv2.quickbase.com/hc/article_attachments/30267023632788" alt="New Navigation" width="300px" />
      <article>Rolled out in 2024, Quickbase's navigation has been rebuilt from the ground up to provide a more modern and intuitive experience for users. Initial release of our new navigation re-arranges the components users use to navigate around the apps today. My contribution to this feature was as follows</article>
      <ContributionList>
      ...
      <br />
      <h3><strong>New Forms Experience</strong> (<a href={hrefs.newFormsExperience} target="_blank" rel="noopener noreferrer">Release Notes</a>)</h3>
      <WrappedImg src="https://helpv2.quickbase.com/hc/article_attachments/27269565298196" alt="New Forms Experience" width="400px" />
      <article>Released in 2023, new form experience is ready for mission critical use-cases. Form builders now have a drag-and-drop what-you-see-is-what-you-get experience when designing forms that will take them from idea to solution faster than ever before. I personally built and refined more than dozen field components and embeded existing reports into the new form experience. These are my contributions</article>
      <ContributionList>
        <li>Built and improved 10+ field components for the new forms. Dealt with numbers, decimals, strings, dates as well as more complex types like users and file attachments;</li>
      ...
      <br />
      <h3><strong>New Dashboard Widget</strong> (<a href={hrefs.newDashboardWidget} target="_blank" rel="noopener noreferrer">Release Notes</a>)</h3>
      <WrappedImg src="https://helpv2.quickbase.com/hc/article_attachments/4522850223380/jan.image.1.png" alt="New Dashboard Widget" />
      <article>Released in 2022, calendar report for the new dashboards have new look and feel, making them more vibrant and easier to resize. Supports view to see a single day, week, or month, as well as drag and drop events on the calendar to update start or end dates. I contributed to this feature by building the calendar report component and improving backend APIs. Here are my contributions:</article>

      <ContributionList>
        <li>Built the component and improved behavior under different use-case (timezones, updates);</li>
